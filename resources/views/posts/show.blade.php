                        ...
                        <div class="max-w-2xl mx-auto px-4">
                            ...
                            <form action="{{ route('comments.store', $post) }}" method="POST" class="mb-6">
                                ...
                                <div class="py-2 px-4 mb-4 bg-white rounded-lg rounded-t-lg border border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <textarea name="body" id="body" rows="6" class="px-0 w-full text-sm text-gray-900 border-0 focus:ring-0 focus:outline-none dark:text-white dark:placeholder-gray-400 dark:bg-gray-800" placeholder="Escribe tu comentario..." required></textarea>
                                </div>
