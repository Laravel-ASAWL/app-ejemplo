                ...
                <div class="py-2 border-b border-slate-900/10 lg:px-8 lg:border-0 dark:border-slate-300/10 px-4">
                    <div class="relative flex items-center">
                        <a href="{{ url('/') }}" class="relative flex items-center">
                            ...
                            <div class="relative">
                                <span class="text-xs leading-5 font-semibold bg-slate-400/20 rounded-full py-1 px-3 flex items-center space-x-2 dark:highlight-white/5">Laravel ASAWL - App de Ejemplo</span>
                            </div>
                        </a>
